    ...
    <main className="mx-auto max-w-5xl px-6 py-16 font-sans min-h-screen bg-white dark:bg-black transition-colors duration-700">
      ...
      <header className="mb-20">
        <motion.div 
          ...
          className="text-left"
        >
          <h1 className="mb-6 text-6xl font-black tracking-tighter text-black dark:text-white sm:text-8xl uppercase">
            ReadMeNot<span className="text-blue-600">.</span>
          </h1>
          <p className="max-w-xl text-lg font-bold text-zinc-500 dark:text-white leading-tight">
      ...
      {isLoading ? (
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-64 rounded-[48px] border-[5px] border-zinc-100 dark:border-zinc-900 animate-pulse bg-zinc-50 dark:bg-zinc-900/20" />
          ))}
        </div>
      ) : (
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
              ...
              filteredResources.map((resource: any) => (
                ...
                >
                  ...
                  >
                    ...
                    <div className="mt-12 flex items-center text-[11px] font-black uppercase tracking-widest text-zinc-400 dark:text-white group-hover:text-white transition-colors">
